...
object LegacyTargetProjector {
    ...
    fun project(
        ...
        val recruitmentByProfile = recruitment.groupBy { it.executionProfileId }
        ...
        routineSlots.forEach { slot ->
            ...
            recruitmentByProfile[profile.id]
                .orEmpty()
        ...
        val sessionExerciseTargets = sessionExercises.flatMap { sessionExercise ->
            ...
            val recruitedSegments = recruitmentByProfile[sessionExercise.executionProfileId]
                .orEmpty()
