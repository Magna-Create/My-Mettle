...
internal fun MettleControlGlassSurface(
    ...
    Box(modifier = modifier.then(innerShadowModifier)) {
        MettleGlassSurface(
            modifier = Modifier.fillMaxSize(),
            shape = shape,
            tint = tint,
            baseColor = Color.Transparent,
            // These are the current global hotbar optics. Keep this primitive as the material
            // source of truth rather than re-tuning individual buttons by eye.
            blurRadius = 8.5.dp,
