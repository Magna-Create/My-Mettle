...
class NBio7DNonDynamicDownstreamFidelityTest {
    ...
    fun `7C loaded hold adaptive sparse approximation remains quantified after 7D projection`() {
        ...
        assertTrue(denseDemand.empiricalStatuses.contains(SetDemandEmpiricalStatus.EMPIRICAL_ACCURACY_PENDING))
        assertTrue(denseDemand.empiricalStatuses.contains(SetDemandEmpiricalStatus.EMPIRICAL_CALIBRATION_PENDING))
    }
