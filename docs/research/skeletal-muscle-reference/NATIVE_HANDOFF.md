...
**Implementation update:** N-BIO-1 and N-BIO-2 are combined in the Room v5 biological foundation. N-BIO-3 adds the Room v6 independent target/prescription split. N-BIO-4 adds the Room v7 user-state/inference scaffold. N-BIO-5 adds the Room v8 target-driven programme/mode resolver.
